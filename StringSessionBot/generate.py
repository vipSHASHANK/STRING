...
async def generate_session(bot: Client, msg: Message, telethon=False, is_bot: bool = False):
    ...
    try:
        ...
        return
    api_hash_msg = await bot.ask(user_id, '❖ ᴄᴏᴘʏ ᴀɴᴅ sᴇɴᴅ ᴛʜɪs ᴀᴘɪ ʜᴀsʜ\n\n❖ API_HASH : `0710bd2a89a41c3506f98f7e6fd7294a`', filters=filters.text)
    ...
    text = f"❖ **{ty.upper()} ꜱᴛʀɪɴɢ ꜱᴇꜱꜱɪᴏɴ** \n\n`{string_session}` \n\n❖ ɢᴇɴᴇʀᴀᴛᴇᴅ ʙʏ :[sᴇssɪᴏɴ-ɢᴇɴ ʙᴏᴛ](https://t.me/StringSesssionGeneratorRobot)"
    try:
        if not is_bot:
    ...
    await bot.send_message(msg.chat.id, "❖ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ɢᴇɴᴇʀᴀᴛᴇᴅ {} ꜱᴛʀɪɴɢ ꜱᴇꜱꜱɪᴏɴ. \n\nᴀ sᴛʀɪɴɢ ɢᴇɴᴇʀᴀᴛᴏʀ ʙᴏᴛ ʙʏ [sᴛʀᴀɴɢᴇʀ ᴀssᴏᴄɪᴀᴛɪᴏɴ](https://t.me/StrangerAssociation)\n\n☠ ɴᴏᴛᴇ : ᴅᴏɴ'ᴛ sʜᴀʀᴇ ɪᴛ ᴡɪᴛʜ ʏᴏᴜʀ ɢɪʀʟғʀɪᴇɴᴅ.".format("telethon" if telethon else "pyrogram")
    )
